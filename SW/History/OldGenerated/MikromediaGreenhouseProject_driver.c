...
static void InitializeObjects() {
  ...
  temperature_label.Width           = 50;
  temperature_label.Height          = 50;
  ...
  humidity_label.Width           = 50;
  humidity_label.Height          = 50;
  ...
  servo_number_button_14.OnClickPtr      = servo_number_button_15OnClick;
